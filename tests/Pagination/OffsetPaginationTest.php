...
class OffsetPaginationTest extends TestCase
{
    ...
    {
        $pagination = new OffsetPagination(['a', 'b', 'c'], 10);
    ...
    public function testWithItemsPreservesMetadata(): void
    {
        ...
        $this->assertSame(3, $new->getCurrentPage());
        $this->assertSame(30, $new->getOffset());
    ...
    {
        $original = new OffsetPagination(['a', 'b'], 10);
    ...
    {
        $pagination = new OffsetPagination(['a'], 10);
        $new = $pagination->withItems(['x']);

        $this->assertInstanceOf(OffsetPagination::class, $new);
    }
}
